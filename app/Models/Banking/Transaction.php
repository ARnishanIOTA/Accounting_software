...
class Transaction extends Model
{
    ...
    /**
     * Scope to include only Monthly.
     *
     * @param \Illuminate\Database\Eloquent\Builder $query
     * @return \Illuminate\Database\Eloquent\Builder
     */

    public function scopeMonthly($query, $fromDate, $tillDate)
    {
        return $query->whereBetween($this->table . '.created_at', array($fromDate, $tillDate));
    }
