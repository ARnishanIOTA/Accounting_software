                ...
                <table class="table table-flush table-hover">
                    <thead class="thead-light">
                        <tr class="row table-head-line">
                            ...
                            <th class="col-xs-4 col-sm-3 col-md-3 col-lg-account">@sortablelink('account_id', trans_choice('general.accounts', 1))</th>
                            <th class="col-lg-2 d-none d-lg-block">{{ trans('general.period') }}</th>
                            <th class="col-md-2 col-lg-closingBalance d-none d-md-block text-right">@sortablelink('closing_balance', trans('reconciliations.closing_balance'))</th>
                            <th class="col-xs-4 col-sm-2 col-md-2 col-lg-status">@sortablelink('status', trans_choice('general.statuses', 1))</th>
                    ...
                    <tbody>
                        @foreach($reconciliations as $item)
                            <tr class="row align-items-center border-top-1">
                                ...
                                <td class="col-xs-4 col-sm-3 col-md-3 col-lg-account">{{ $item->account->name }}</td>
                                <td class="col-lg-2 d-none d-lg-block border-0">@date($item->started_at) - @date($item->ended_at)</td>
                                <td class="col-md-2 col-lg-closingBalance d-none d-md-block text-right">@money($item->closing_balance, $item->account->currency_code, true)</td>
                                <td class="col-xs-4 col-sm-2 col-md-2 col-lg-status">
                                    @if ($item->reconciled)
