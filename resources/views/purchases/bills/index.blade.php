                ...
                <table class="table table-flush table-hover">
                    <thead class="thead-light">
                        <tr class="row table-head-line">
                            ...
                            <th class="col-xs-4 col-sm-4 col-md-3 col-lg-2 col-lg-customer text-left">@sortablelink('contact_name', trans_choice('general.vendors', 1))</th>
                            <th class="col-md-2 col-lg-2 col-lg-ammount d-none d-md-block text-right">@sortablelink('amount', trans('general.amount'))</th>
                            <th class="col-lg-2 col-lg-invoice d-none d-lg-block text-left">@sortablelink('billed_at', trans('bills.bill_date'))</th>
                            <th class="col-lg-2 col-lg-due d-none d-lg-block text-left">@sortablelink('due_at', trans('bills.due_date'))</th>
                            <th class="col-xs-4 col-lg-status col-md-2 col-lg-1 col-xl-1 text-center">@sortablelink('status', trans_choice('general.statuses', 1))</th>
