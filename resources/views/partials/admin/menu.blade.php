...
{{--                    </div>--}}
            ...
            <div class="sidenav-toggler d-none d-xl-block left-menu-toggle custom-toggle-nishan" data-action="sidenav-unpin" data-target="#sidenav-main">
                <div class="sidenav-toggler-inner inner-toogle">
                    <i class="sidenav-toggler-line"></i>
                    <i class="sidenav-toggler-line"></i>
                    <i class="sidenav-toggler-line"></i>
                </div>
