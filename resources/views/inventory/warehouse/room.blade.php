                                ...
                                <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                     <div class="modal-dialog" role="document">
                                       <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{ route('inventory.warehouse.editRoom') }}">
                                            {{ csrf_field() }}
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="rname" class="form-control" id="roomname">
                                                    <input type="hidden" name="id" class="form-control" id="roomid" >           
                                                </div>
            ...
            <table class="table table-flush table-hover">
                <thead class="thead-light">
                    <tr class="row table-head-line">
                        <th class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3  d-none d-sm-block ">Flat Name</th>

                        <th class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3  d-none d-sm-block text-center">Room Name</th>
                           ...
                           <td class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3   d-none d-sm-block ">
                            ...
                            <td class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3   text-center">
                                <div class="dropdown">
                                    ...
                                    <button type="button" class="dropdown-item" data-toggle="modal" data-target="#editModal" onclick="edit(event,' {{$item->name}}',' {{$item->id}}')">Edit</button>
